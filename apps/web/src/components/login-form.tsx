...
export const LoginForm: React.FC = () => {
    ...
    return <div className='flex flex-col items-center gap-4 border border-neutral-200 dark:border-neutral-500 px-4 py-6'>
        <h1 className='font-semibold text-xl text-center'>Log in to your account </h1>
        <form className='flex flex-col gap-4 w-full ' onSubmit={submit}>
            ...
            <p className="text-center"> Don't have a Zapier account yet? <Link className="underline" href={"/signup"}>Sign Up</Link></p>
