  ...
  return (
    <>
      <div className="mt-10 max-w-7xl mx-auto flex flex-col gap-6 items-center justify-center ">
        ...
        <p className="text-sm text-center w-xl">
          Zapier gives teams one place to set guardrails, manage model access,
          and see everything — so everyone can build with AI confidently, on any
          model, without waiting for permission.
        </p>
        <div className="flex gap-4">
          <Button variant={"secondary"}>Start free with email</Button>
          <Button className="border dark:border-neutral-400 border-neutral-200">
